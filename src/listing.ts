...
export interface CloudFolderPrefetch { files: { name: string; eTag: string; size: number; lastModifiedDateTime?: string | number; ref?: string }[]; folders: string[]; complete: boolean }
